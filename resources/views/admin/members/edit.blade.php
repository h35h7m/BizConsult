              ...
              @csrf
               ...
               <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"  name="postion" class="form-control" placeholder="{{ __('keywords.postion') }}" value='{{ $member->postion }}'>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text"  name="facebook" class="form-control" placeholder="{{ __('keywords.facebook') }}" value='{{ $member->postion }}'>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text"  name="twitter" class="form-control" placeholder="{{ __('keywords.twitter') }}" value='{{ $member->postion }}'>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text"  name="linkedin" class="form-control" placeholder="{{ __('keywords.linkedin') }}" value='{{ $member->postion }}'>
