<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        ...
        {{-- members --}}
        <x-sidebar-tab href="{{ route('admin.members.index') }}" icon="fe-user-plus" name="{{ __('keywords.members') }}" ></x-sidebar-tab> 
        
        {{-- companies --}}
        <x-sidebar-tab href="{{ route('admin.companies.index') }}" icon="fe-smile" name="{{ __('keywords.companies') }}" ></x-sidebar-tab> 
